...
i = 0
while(i<5):
    x = int(input('Please write a number between 3 to 7 for creat a random password.'))
    my_emptylist2 = []
    if (x==3):
        my_emptylist2 = random.choices(words, k=3)

    elif (x==4):
        my_emptylist2 = random.choices(words, k=4)

    elif (x==5):
        my_emptylist2 = random.choices(words, k=5)

    elif (x==6):
        my_emptylist2 = random.choices(words, k=6)

    elif (x==7):
        my_emptylist2 = random.choices(words, k=7)

    password = "".join(my_emptylist2)
...
#Question4
dictionary3 = {1:['Tony', 41] , 2:['Steve', 39], 3:['Nat', 35]}
